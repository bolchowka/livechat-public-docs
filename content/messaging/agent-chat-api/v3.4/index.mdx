...
<Code>
<CodeResponse version="v3.4" type="agent" title={'Sample File in response'} json="file"/>
</Code>
</Section>
...
<div style="max-width: 300px">
  <img src="../form-event-image.png" alt="Gather contact info with LiveChat form event" />
</div>

</Text>

<Code>
<CodeResponse version="v3.4" type="agent" title={'Sample Form in response'} json="form"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.4" type="agent" title={'Sample Filled form in response'} json="filledForm"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.4" type="agent" title={'Sample Message in response'} json="message"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.4" type="agent" title={'Sample Rich message in response'} json="richMessage"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.4" type="agent" title={'Sample Custom event in response'} json="custom"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.4" type="agent" title={'Sample System message in response'} json="systemMessage"/>
</Code>
</Section>
...
<CodeResponse version="v3.4" type="agent" title={'Sample Agent data structure'} json="agent"/>
...
<CodeResponse version="v3.4" type="agent" title={'Sample My profile data structure'} json="myProfile"/>
...
<CodeResponse version="v3.4" type="agent" title={'Sample Customer data structure'} json="customer"/>
...
<CodeResponse version="v3.4" type="agent" title={'Sample Access data structure'} json="access"/>
...
<CodeResponse version="v3.4" type="agent" title={'Sample Chat data structure'} json="chat"/>
...
<CodeResponse version="v3.4" type="agent" title={'Sample Chat summary data structure'} json="chatSummary"/>

## Form fields

A component of the [Form](#form) event.

<CodeResponse version="v3.4" type="agent" title={'Sample Form fields'} json="formFields"/>
...
<CodeResponse version="v3.4" type="agent" title={'Sample Form fields'} json="filledFormFields"/>
...
<CodeResponse version="v3.4" type="agent" title={'Sample Properties data structure'} json="properties"/>

## Threads

<CodeResponse version="v3.4" type="agent" title={'Sample Thread data structure'} json="thread"/>
...
| ----------- | -------------------------------------------------------- |
| `POST`      | `https://api.livechatinc.com/v3.4/agent/action/<action>` |
...
|                        |                                                            |
| ---------------------- | ---------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/list_chats` |
...
|                        |                                                              |
| ---------------------- | ------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/list_threads` |
| **Required scopes**    | `chats--all:ro` `chats--access:ro` `chats--my:ro`            |
...
|                        |                                                          |
| ---------------------- | -------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/get_chat` |
| **Required scopes**    | `chats--all:ro` `chats--access:ro` `chats--my:ro`        |
...
|                        |                                                               |
| ---------------------- | ------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/list_archives` |
...
- `values` (`type[]` - an array with aspecific type for property: `string`, `int` or `bool`)
- `exclude_values` (`type[]` - array with specific type for property: `string`, `int` or `bool`)
- `require_every_value` (`bool`) - if set to `true` will return chats that have all elements of `values` or `exclude_values` in the field that the filter applies to

Only one of `exists`, `values` or `exclude_values` may be passed.
...
Only one of `values` or `exclude_values` may be passed.
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/start_chat`                               |
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/resume_chat`                              |
| **Required scopes \*** | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
...
|                        |                                                                       |
| ---------------------- | --------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/deactivate_chat`       |
...
|                        |                                                             |
| ---------------------- | ----------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/follow_chat` |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`           |
...
|                        |                                                               |
| ---------------------- | ------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/unfollow_chat` |
| **Required scopes**    | -                                                             |
...
|                        |                                                                            |
| ---------------------- | -------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/transfer_chat`              |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`                          |
| **RTM API equivalent** | [`transfer_chat`](rtm-reference/#transfer-chat)                            |
| **Webhook**            | [`chat_transferred`](/management/configuration-api/v3.4/#chat_transferred) |
...
|                        |                                                                           |
| ---------------------- | ------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/add_user_to_chat`          |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`                         |
...
|                        |                                                                                   |
| ---------------------- | --------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/remove_user_from_chat`             |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`                                 |
...
|                        |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/send_event`                               |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
...
|                        |                                                                          |
| ---------------------- | ------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/upload_file`              |
| **RTM API equivalent** | -                                                                        |
| **Webhook**            | [`incoming_event`](/management/configuration-api/#incoming_event) **\*** |
...
|                        |                                                                                                         |
| ---------------------- | ------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/send_rich_message_postback`                              |
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/update_chat_properties`                   |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/delete_chat_properties`                   |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/update_thread_properties`                 |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/delete_thread_properties`                 |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/update_event_properties`                  |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/delete_event_properties`                  |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
...
|                        |                                                                 |
| ---------------------- | --------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/tag_thread`      |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`               |
...
|                        |                                                                     |
| ---------------------- | ------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/untag_thread`        |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`                   |
...
|                        |                                                                |
| ---------------------- | -------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/list_customers` |
| **Required scopes**    | `customers:ro`                                                 |
...
| **Webhook**            | [`incoming_customer`](/management/configuration-api/v3.4/#incoming_customer) |
...
|                        |                                                                                                                 |
| ---------------------- | --------------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/update_customer`                                                 |
| **Required scopes**    | `customers:rw`                                                                                                  |
...
|                        |                                                              |
| ---------------------- | ------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/ban_customer` |
...
|                        |                                                                                                        |
| ---------------------- | ------------------------------------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/set_routing_status`                                     |
| **Required scopes**    | for Agents: `agents--my:rw` `agents--all:rw`; for Bot Agents: `agents-bot--my:rw` `agents-bot--all:rw` |
| **RTM API equivalent** | [`set_routing_status`](/messaging/agent-chat-api/v3.4/rtm-reference/#set-routing-status)               |
| **Webhook**            | [`routing_status_set`](/management/configuration-api/v3.4/#routing_status_set)                         |
...
|                        |                                                                       |
| ---------------------- | --------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/list_routing_statuses` |
...
|                        |                                                                                 |
| ---------------------- | ------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/mark_events_as_seen`             |
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/send_typing_indicator`                    |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
...
|                        |                                                           |
| ---------------------- | --------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/multicast` |
...
|                        |                                                                          |
| ---------------------- | ------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.4/agent/action/list_agents_for_transfer` |
| **Required scopes**    | -                                                                        |
